...
Servo myservo;  // create servo object to control a servoa
...
const char* password = NULL;   /*Set Your Password*/
...
static esp_err_t camera_capture(size_t *pictureSize)
{
    //acquire a frame
